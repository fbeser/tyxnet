...
curl -fLO https://github.com/fbeser/tyxnet/releases/download/v0.1.0/tyxnet-server-linux-arm64
curl -fLO https://github.com/fbeser/tyxnet/releases/download/v0.1.0/checksums.txt
